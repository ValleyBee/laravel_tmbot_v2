...
use Telegram\Bot\Objects\ResponseObject as FakeResponse;
use Telegram\Bot\Testing\Responses as FakePayload;
...
//            var_dump($fakeResponseResult);

//            foreach ($message as $key => $value) {
//                Log::channel('stderr')->info('$fakeResponse', [$key, $value]);
//                $fakeResponseResult = FakeResponse::make()->withCustomData($key, $value);
//            }
//            $fakeResponseResult = new FakeResponse(); // ::make()->withCustomData($message['text'], 'test' );

...
//                ],
        ...
        'REPLYMARKUP_MENU_SUB_ONE' => [
            'keyboard' => [
                ...
                [
                    ['text' => "\u{0031}\u{20E3} Famous people born on this date."],
                ],
                [
                    ['text' => "\u{0032}\u{20E3} How far is Earth from Sun in km,today."],
                ],
                [
        ...
        'REPLYMARKUP_MENU_INLINE' => [
            'inline_keyboard' => [
                ...
                [
                    ['text' => 'Doctor of Philosophy in Psychology', 'callback_data' => 0],
                ],
                [
                    ['text' => 'Master of Science in Engineering', 'callback_data' => 1],
                ],
                [
                    ['text' => 'Doctor of Theology in the Christian religion', 'callback_data' => 2],
                ],
                [
                    ['text' => "\u{1F519} Back to maim menu", 'callback_data' => '/cancel'],
                ],
            ],
            'one_time_keyboard' => true,
            'resize_keyboard' => true,
...
//                ],
        ...
        'REPLYMARKUP_MENU_SUB_ONE' => [
            'keyboard' => [
                ...
                [
                    ['text' => "\u{0031}\u{20E3} Відомі люди народженні в цей день."],

                ],
                [
                    ['text' => "\u{0032}\u{20E3} Яка відстань Землі від Сонця,сьогодні."],
                ],
                [
        ...
        'REPLYMARKUP_MENU_INLINE' => [
            'inline_keyboard' => [
                [
                    ['text' => 'Доктор філософії з психології', 'callback_data' => 0],
                ],
                [
                    ['text' => 'Магістр інженерних наук', 'callback_data' => 1],
                ],
                [
                    ['text' => 'Доктор теології в християнській релігії', 'callback_data' => 2],
                ],
                [
                    ['text' => "\u{1F519} Повернутися до головного меню", 'callback_data' => '/cancel'],
                ],
            ],
        ], #end inline
...
//                ],
        ...
        'REPLYMARKUP_MENU_SUB_ONE' => [
            'keyboard' => [
                [
                    ['text' => "\u{1F519} Вернуться в главное меню"],
                ],
                [
                    ['text' => "\u{0031}\u{20E3} Известные люди рождённые в этот день."],
                ],
                [
                    ['text' => "\u{0032}\u{20E3} Каково расстояние Земли от Солнца,сегодня."],
                ],
                [
        ...
        'REPLYMARKUP_MENU_INLINE' => [
            'inline_keyboard' => [
                ...
                [
                    ['text' => 'Доктор философии по психологии', 'callback_data' => 0],
                ],
                [
                    ['text' => 'Магистр инженерных наук', 'callback_data' => 1],
                ],
                [
                    ['text' => 'Доктор теологии в христианской религии', 'callback_data' => 2],
                ],
                [
                    ['text' => "\u{1F519} Вернуться в главное меню", 'callback_data' => '/cancel'],
                ],

...
return [
    ...
    'ENG' => [
        ...
        'INFO' => [
            ...
            'assigning_roles' => "Changing role of AI will effect to the context of its answers.",
        ...
        'REPLYMARKUP_MENU_MAIN' => [
            'keyboard' => [
                ...
                [
                    ['text' => "\u{1F4AC} Change role of AI"],
                ],
                [
    ...
    'UA' => [
        ...
        'INFO' => [
            ...
            'assigning_roles' => "Зміна моделі поведінки AI впливає на контекст відповідей",
        ...
        'REPLYMARKUP_MENU_MAIN' => [
            'keyboard' => [
                ...
                [
                    ['text' => "\u{1F4AC} Змініти модель поведінки AI"],
                ],
                [
        ...
        'REPLYMARKUP_MENU_INLINE' => [
            'inline_keyboard' => [
                ...
                [
                    ['text' => 'Доктор філософії з психології', 'callback_data' => 1],
                    ['text' => 'Магістр інженерних наук', 'callback_data' => 2],
                    ['text' => 'Доктор теології в християнській релігії', 'callback_data' => 3],
                ],
    ...
    'RU' => [
        ...
        'INFO' => [
            ...
            'assigning_roles' => "Зминения модели поведения AI отразится на контексте ответов",
        ...
        'REPLYMARKUP_MENU_MAIN' => [
            'keyboard' => [
                ...
                [
                    ['text' => "\u{1F4AC} Изменить модель поведения AI"],
                ],
                [
        ...
        'REPLYMARKUP_MENU_INLINE' => [
            'inline_keyboard' => [
                ...
                [
                    ['text' => 'Доктор философии по психологии', 'callback_data' => 1],
                    ['text' => 'Магистр инженерных наук', 'callback_data' => 2],
                    ['text' => 'Доктор теологии в христианской религии', 'callback_data' => 3],
                ],
